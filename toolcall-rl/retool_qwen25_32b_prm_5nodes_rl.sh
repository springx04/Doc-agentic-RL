...
HF_CKPT=${HF_CKPT:-/data_storage/wyj/systems/huggingface/hub/qwen25-32b-document-tool-sft}
REF_LOAD=${REF_LOAD:-/data_storage/wyj/systems/huggingface/hub/qwen25-32b-document-tool-sft_torch_dist}
SAVE_CKPT=${SAVE_CKPT:-/data_storage/wyj/slime_export/ckpt/qwen25-32b-document-tool-prm-rl}
PROMPT_DATA=${PROMPT_DATA:-/data_storage/wyj/slime_export/data/document-qa/train.jsonl}
EVAL_DATA=${EVAL_DATA:-/data_storage/wyj/slime_export/data/document-qa/eval.jsonl}
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project document_tool_rl
   --wandb-group qwen25-32b-document-tools-5nodes-prm
   --wandb-key "${WANDB_KEY}"
)
