...
HF_CKPT=${HF_CKPT:-/data_storage/wyj/systems/huggingface/hub/qwen3-4b-document-tool-sft}
REF_LOAD=${REF_LOAD:-/data_storage/wyj/systems/huggingface/hub/qwen3-4b-document-tool-sft_torch_dist}
SAVE_CKPT=${SAVE_CKPT:-/data_storage/wyj/OpenClaw-RL/ckpt/qwen3-4b-document-tool-prm-rl}
PROMPT_DATA=${PROMPT_DATA:-/data_storage/wyj/OpenClaw-RL/data/document-qa/train.jsonl}
EVAL_DATA=${EVAL_DATA:-/data_storage/wyj/OpenClaw-RL/data/document-qa/eval.jsonl}
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4b-document-tools-prm
   --wandb-key "${WANDB_KEY}"
)
