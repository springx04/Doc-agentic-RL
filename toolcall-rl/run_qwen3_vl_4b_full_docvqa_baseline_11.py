"""Run a fresh full DocVQA baseline with the multi-turn document hook."""
...
OUTPUT_DIR = (
    ...
    / "outputs"
    / "qwen3-vl-4b-docvqa-baseline-20260730-05-multiturn200"
).resolve()
RAY_TEMP_DIR = (profile.profile.base.WORKSPACE / ".ray" / "r05").resolve()
